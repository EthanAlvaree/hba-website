...
export default async function FacultyDetailPage({ params }: Props) {
  ...
  const personJsonLd = {
    ...
    worksFor: {
      ...
      url: "https://highbluffacademy.com",
    },
  }
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6 lg:px-12 grid gap-12 lg:grid-cols-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-5">
            <Link
              href="/faculty"
              className="inline-flex items-center text-sm font-semibold text-[#1f3f66] hover:text-[#f37021] transition"
            >
              ← Faculty and staff
            </Link>

            <div className="text-xs font-bold tracking-[0.18em] uppercase text-[#f37021]">
              {member.area}
            </div>
        ...
        <section className="border-y border-gray-200 bg-white">
          <div className="max-w-6xl mx-auto px-6 lg:px-12 py-8 grid gap-4 sm:grid-cols-3 items-center">
            ...
            >
              ...
              <div className="text-sm font-semibold text-[#1f3f66] group-hover:text-[#f37021] transition">
                {neighbors.prev.name}
              </div>
            ...
            <div className="text-center">
              <Link
                href="/faculty"
                className="inline-flex items-center justify-center px-5 py-2 rounded-full border border-[#1f3f66] text-[#1f3f66] font-semibold text-xs hover:bg-[#1f3f66] hover:text-white transition"
              >
                All faculty
              </Link>
            </div>
      ...
      <section className="py-20 bg-[#1f3f66]">
        <div className="reveal max-w-3xl mx-auto px-6 lg:px-12 text-center space-y-5">
          ...
          <div className="flex flex-wrap justify-center gap-3 pt-2">
            ...
            <Link
              href="/admissions"
              className="inline-flex items-center justify-center px-6 py-3 rounded-full border border-white/40 text-white font-semibold text-sm hover:bg-white hover:text-[#1f3f66] transition"
            >
              Explore admissions
            </Link>
          </div>
