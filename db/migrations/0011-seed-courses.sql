...
values
  ...
  ('MATH-HIM1', 'Honors Integrated Math 1', 'Mathematics', 'math', null, array['9']::text[], false, true, false, 1, true),
  ('MATH-HIM2', 'Honors Integrated Math 2', 'Mathematics', 'math', null, array['10']::text[], false, true, false, 1, true),
  ('MATH-HIM3', 'Honors Integrated Math 3', 'Mathematics', 'math', null, array['11']::text[], false, true, false, 1, true),
  ('MATH-PRECALC', 'Intro to Calculus', 'Mathematics', 'math', null, array['11', '12']::text[], false, false, false, 1, true),
  ('MATH-HPRECALC', 'Honors Precalculus', 'Mathematics', 'math', null, array['10', '11', '12']::text[], false, true, false, 1, true),
  ...
  ('MATH-HLINALG', 'Honors Linear Algebra', 'Mathematics', 'math', null, array['11', '12']::text[], false, true, false, 1, true),
  ('MATH-HMULTIVAR', 'Honors Multivariable Calculus', 'Mathematics', 'math', null, array['11', '12']::text[], false, true, false, 1, true),
  ('MATH-HGROUP', 'Honors Group Theory and Abstract Algebra', 'Mathematics', 'math', null, array['11', '12']::text[], false, true, false, 1, true),
  ('MATH-HSET', 'Honors Set Theory and Real Analysis', 'Mathematics', 'math', null, array['11', '12']::text[], false, true, false, 1, true),
  ('MATH-HMLMATH', 'Honors Mathematics of Machine Learning', 'Mathematics', 'math', null, array['11', '12']::text[], false, true, false, 1, true),
  ('SCI-BIO', 'Biology: The Living Earth', 'Science', 'science', null, array['9', '10']::text[], false, false, false, 1, true),
  ('SCI-HBIO', 'Honors Biology', 'Science', 'science', null, array['9', '10']::text[], false, true, false, 1, true),
  ('SCI-CHEM', 'Chemistry: In the Earth System', 'Science', 'science', null, array['10', '11']::text[], false, false, false, 1, true),
  ('SCI-HCHEM', 'Honors Chemistry: In the Earth System', 'Science', 'science', null, array['10', '11']::text[], false, true, false, 1, true),
